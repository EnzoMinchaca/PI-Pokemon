...
const getPokeApiInfo = async() => {
    try {
        ...
        const infoApi = await axios.get('https://pokeapi.co/api/v2/pokemon?offset=0&limit=14')  //tengo que hacer otra request xq dentro hay una url donde esta mas info, results es un array de objetos    data = {results: [], etc}
